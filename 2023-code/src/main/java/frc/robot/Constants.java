...
public final class Constants {
    public static class AutoConstants {
        ...
        public static class TrajectoryConstants {
            ...
            public static final Translation2d FLIPPED_FIRST_COOPERTITION_CONE_NODE = new Translation2d(Units.feetToMeters(0),
                    -Units.inchesToMeters(86));
    ...
    public static class DriveConstants {
        ...
        public static final double DRIVE_REDUCTION = (14.0 / 50.0) * (27.0 / 17.0) * (15.0 / 45.0); // Constant for SDS
                                                                                                    // MK4i
                                                                                                    // Modules
        ...
        public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = MAX_VELOCITY_METERS_PER_SECOND
                / Math.hypot(DriveConstants.DRIVETRAIN_TRACKWIDTH_METERS / 2,
    ...
    public static class ElevatorConstants {
        ...
        public static final float ELEVATOR_FORWARD_SOFT_LIMIT_METERS = (float) Units
                .inchesToMeters(ELEVATOR_MAX_POS_IN); // TODO
                                                      // update
                                                      // with
                                                      // correct
                                                      // values
