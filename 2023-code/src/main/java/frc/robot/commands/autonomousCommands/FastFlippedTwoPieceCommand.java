...
public class FastFlippedTwoPieceCommand extends SequentialCommandGroup {
  ...
  public FastFlippedTwoPieceCommand(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake, WristSubsystem wrist) {
