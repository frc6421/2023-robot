...
public class FastTwoPieceCommand extends SequentialCommandGroup {
  ...
  public FastTwoPieceCommand(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake, WristSubsystem wrist) {
