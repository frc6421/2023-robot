...
public class FlippedFourPieceCommand extends SequentialCommandGroup {
  private DriveSubsystem driveSubsystem;

  private Field2d field;

  /** Creates a new FlippedFourPieceCommand. */
  public FlippedFourPieceCommand(DriveSubsystem drive) {
      ...
      Trajectory pickUpTrajectoryOne = TrajectoryGenerator.generateTrajectory(List.of(
          new Pose2d(TrajectoryConstants.FLIPPED_SECOND_CONE_NODE, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FOURTH_GAME_PIECE, new Rotation2d(Units.degreesToRadians(0)))), forwardConfig);
  
      // Score cube (high)
      Trajectory scoreTrajectoryOne = TrajectoryGenerator.generateTrajectory(List.of(
          new Pose2d(TrajectoryConstants.FLIPPED_FOURTH_GAME_PIECE, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FAR_EDGE_OF_COMMUNITY, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_CUBE_NODE, new Rotation2d(Units.degreesToRadians(0)))), reverseConfig);
  
      // Pick up second cone
      Trajectory pickUpTrajectoryTwo = TrajectoryGenerator.generateTrajectory(List.of(
          new Pose2d(TrajectoryConstants.FLIPPED_CUBE_NODE, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FAR_EDGE_OF_COMMUNITY, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_THIRD_GAME_PIECE, new Rotation2d(Units.degreesToRadians(0)))), forwardConfig);
  
      // Score second cone (high)
      Trajectory scoreTrajectoryTwo = TrajectoryGenerator.generateTrajectory(List.of(
          new Pose2d(TrajectoryConstants.FLIPPED_THIRD_GAME_PIECE, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FAR_EDGE_OF_COMMUNITY, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FIRST_CONE_NODE, new Rotation2d(Units.degreesToRadians(0)))), reverseConfig);
  
      // Pick up third cone
      Trajectory pickUpTrajectoryThree = TrajectoryGenerator.generateTrajectory(List.of(
          new Pose2d(TrajectoryConstants.FLIPPED_FIRST_CONE_NODE, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FAR_EDGE_OF_COMMUNITY, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_SECOND_GAME_PIECE, new Rotation2d(Units.degreesToRadians(0)))), forwardConfig);
  
      // Score third cone (mid)
      Trajectory scoreTrajectoryThree = TrajectoryGenerator.generateTrajectory(List.of(
          new Pose2d(TrajectoryConstants.FLIPPED_SECOND_GAME_PIECE, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_FAR_EDGE_OF_COMMUNITY, new Rotation2d(Units.degreesToRadians(0))),
          new Pose2d(TrajectoryConstants.FLIPPED_SECOND_CONE_NODE, new Rotation2d(Units.degreesToRadians(0)))), reverseConfig);
