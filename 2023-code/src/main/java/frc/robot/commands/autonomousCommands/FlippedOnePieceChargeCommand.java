...
public class FlippedOnePieceChargeCommand extends SequentialCommandGroup {
  private DriveSubsystem driveSubsystem;
  private ElevatorSubsystem elevatorSubsystem;
  private ArmSubsystem armSubsystem;
  private GrabberSubsystem grabberSubsystem;
  /** Creates a new FlippedOnePieceChargeCommand. */
  public FlippedOnePieceChargeCommand(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, GrabberSubsystem grabber) {
    ...
    // Starts in line with the left cone node in co-op grid
    Trajectory chargeStationTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        new Pose2d(TrajectoryConstants.FLIPPED_SECOND_COOPERTITION_CONE_NODE, new Rotation2d(0)),
        new Pose2d(TrajectoryConstants.FLIPPED_FAR_EDGE_OF_COMMUNITY, new Rotation2d(0)),
        new Pose2d(TrajectoryConstants.FLIPPED_MID_POINT_OF_PIECES_AND_CHARGE_STATION, new Rotation2d(0)),
        new Pose2d(TrajectoryConstants.FLIPPED_CENTER_OF_CHARGE_STATION, new Rotation2d(0))), forwardConfig);
