...
public class FlippedTwoPieceChargeCommand extends SequentialCommandGroup {
  ...
  public FlippedTwoPieceChargeCommand(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm,
    ...
    Trajectory chargeStationTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        ...
        new Pose2d(TrajectoryConstants.FLIPPED_COOPERTITION_CUBE_NODE.plus(new Translation2d(Units.inchesToMeters(36), 0)), new Rotation2d(0)),
        new Pose2d(TrajectoryConstants.FLIPPED_CENTER_OF_CHARGE_STATION, new Rotation2d(0))), chargeConfig);
