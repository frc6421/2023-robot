...
public class TestAutoCommand extends SequentialCommandGroup {
  ...
  public TestAutoCommand(DriveSubsystem drive) {
    ...
    /**
     * Generate trajectory using quintic hermite splines to control heading
     * independent of robot position
     */
    ...
    SwerveControllerCommand testSwerveControllerCommand = new SwerveControllerCommand(
        testTrajectory,
