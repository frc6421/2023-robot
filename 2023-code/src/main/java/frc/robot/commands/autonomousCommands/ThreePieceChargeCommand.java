...
public class ThreePieceChargeCommand extends SequentialCommandGroup {
  private DriveSubsystem driveSubsystem;

  /**
   * Creates a new ThreePieceChargeCommand. Scores a full link on the high row,
   * then balances the charge station
   */
  public ThreePieceChargeCommand(DriveSubsystem drive) {
    ...
    Trajectory chargeStationTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        ...
        new Pose2d(TrajectoryConstants.CENTER_OF_CHARGE_STATION, new Rotation2d(Units.degreesToRadians(0)))),
        forwardConfig);
