...
public class TwoPieceChargeCommand extends SequentialCommandGroup {
  ...
  public TwoPieceChargeCommand(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake, WristSubsystem wrist) {
    ...
    TrajectoryConfig chargeConfig = new TrajectoryConfig(
        ...
        AutoConstants.AUTO_CHARGE_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED + 1)
        .setKinematics(driveSubsystem.swerveKinematics);
    ...
    Trajectory firstPickUpTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        ...
        new Pose2d(TrajectoryConstants.FOURTH_GAME_PIECE.plus(new Translation2d(0, Units.feetToMeters(0))), new Rotation2d(0))), forwardConfig);

    // Return to score cube next to cone
    Trajectory firstScoreTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        new Pose2d(TrajectoryConstants.FOURTH_GAME_PIECE.plus(new Translation2d(0, Units.feetToMeters(0))), new Rotation2d(0)),
    ...
    Trajectory chargeStationTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        ...
        new Pose2d(TrajectoryConstants.SECOND_COOPERTITION_CONE_NODE.plus(new Translation2d(Units.inchesToMeters(30), 0)), new Rotation2d(0)),
        new Pose2d(TrajectoryConstants.CENTER_OF_CHARGE_STATION.plus(new Translation2d(Units.feetToMeters(2), -Units.inchesToMeters(21.39))), new Rotation2d(0))), chargeConfig);
